...
public class Exerc6 {
	...
	public static void main(String[] args) {
		...
		while(opcao !=0) {
			...
			case 4:
				...
				break;
			case 5:
				pesquiaUltimoIndice(scan, lista);
				break;
			case 6:
				obtemContato(scan, lista);
				break;
	...
	private static void obtemContatoPosicao(Scanner scan, Lista<Contato> lista) {
		...
		try {
			...
			System.out.println("Segue informação do contato");
...
private static void pesquiaUltimoIndice(Scanner scan, Lista<Contato> lista) {
	...
	try {
		...
		System.out.println("Fazendo pesquisa do ultimo índica do contato encontrado:");
		pos = lista.ultimaPos(contato);
	...
	private static void adicionarContatoFinal(Scanner scan, Lista<Contato> lista) {
		System.out.println("Entre com os dados do contato novo");
		String nome = leInformacao("Entre com o nome", scan);
		String telefone = leInformacao("Entre com o telefone", scan);
		String email = leInformacao("Ente com o email", scan);
	...
	private static void adicionarContatoPosicao(Scanner scan, Lista<Contato> lista) {
		...
		int pos = leInformacaoInt("Entre com a posição que deseja adicionar o contato", scan);
	...
	protected static int obterOpcaoMenu(Scanner scan) {
		...
		while(!entradaValida){
			...
			System.out.println("3: Obtem contato em uma posição específica");
